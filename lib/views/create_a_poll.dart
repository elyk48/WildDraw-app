...
class MyPollForm {
  ...
  setData2() {
    ...
    DocumentReference ds =
        FirebaseFirestore.instance.collection('poll').doc(question);
...
class _MyPollCreate2State extends State<MyPollCreate2> {
  ...
  Widget build(BuildContext context) {
    List<Widget> options =
        List.generate(optionCount, (int i) => InputWidget(i));
    return Scaffold(
...
class _InputWidgetState extends State<InputWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.fromLTRB(MediaQuery.of(context).size.width * .15, 0,
